CREATE DATABASE  IF NOT EXISTS `dogocms` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `dogocms`;
-- MySQL dump 10.13  Distrib 5.6.13, for osx10.6 (i386)
--
-- Host: localhost    Database: dogocms
-- ------------------------------------------------------
...
--
-- Table structure for table `ding_adddceshi19`
--

DROP TABLE IF EXISTS `ding_adddceshi19`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_adddceshi19` (
...
--
-- Dumping data for table `ding_adddceshi19`
--

LOCK TABLES `ding_adddceshi19` WRITE;
/*!40000 ALTER TABLE `ding_adddceshi19` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_adddceshi19` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_ads`
--
...
--
-- Dumping data for table `ding_ads`
--

LOCK TABLES `ding_ads` WRITE;
/*!40000 ALTER TABLE `ding_ads` DISABLE KEYS */;
INSERT INTO `ding_ads` VALUES (4,1,'dedede','de','',0,'y','222',1380373564,1388467087);
/*!40000 ALTER TABLE `ding_ads` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_ads_sort`
--
...
--
-- Dumping data for table `ding_ads_sort`
--

LOCK TABLES `ding_ads_sort` WRITE;
/*!40000 ALTER TABLE `ding_ads_sort` DISABLE KEYS */;
INSERT INTO `ding_ads_sort` VALUES (1,'首页2','y',1388467081),(2,'内容页','y',NULL);
/*!40000 ALTER TABLE `ding_ads_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_api`
--

DROP TABLE IF EXISTS `ding_api`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_api` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `apiname` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'API用户名',
  `secretkey` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'API密钥',
  `signature
signature` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '签名',
  `status` varchar(45) COLLATE utf8_unicode_ci DEFAULT '20' COMMENT '状态20启用，10禁用',
  `addtime` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '添加时间',
  `members_id` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '会员编号',
  `domain` text COLLATE utf8_unicode_ci COMMENT '授权站点使用英文半角逗号隔开',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='API接口管理';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_api`
--

LOCK TABLES `ding_api` WRITE;
/*!40000 ALTER TABLE `ding_api` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_api` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_attribute_list`
--

DROP TABLE IF EXISTS `ding_attribute_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_attribute_list` (
  ...
  `myorder` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `ding_auth_group`
--

LOCK TABLES `ding_auth_group` WRITE;
/*!40000 ALTER TABLE `ding_auth_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_auth_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_auth_group_access`
--
...
--
-- Dumping data for table `ding_auth_group_access`
--

LOCK TABLES `ding_auth_group_access` WRITE;
/*!40000 ALTER TABLE `ding_auth_group_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_auth_group_access` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_auth_rule`
--
...
--
-- Dumping data for table `ding_auth_rule`
--

LOCK TABLES `ding_auth_rule` WRITE;
/*!40000 ALTER TABLE `ding_auth_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_auth_rule` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_block_list`
--

DROP TABLE IF EXISTS `ding_block_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_block_list` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `sort_id` smallint(6) NOT NULL COMMENT '碎片分类id',
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '碎片标题',
  `description` tinytext COLLATE utf8_unicode_ci COMMENT '描述',
  `addtime` int(10) NOT NULL COMMENT '添加时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间',
  `title_img` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '图片',
  `status` tinyint(4) NOT NULL DEFAULT '20' COMMENT '状态，默认20为开启，10禁用',
  `url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'url地址',
  `myorder` tinyint(4) DEFAULT '0' COMMENT '排序',
  `field1` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备用字段1',
  `field2` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备用字段2',
  `field3` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备用字段3',
  `field4` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备用字段4',
  `field5` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备用字段5',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_block_list`
--

LOCK TABLES `ding_block_list` WRITE;
/*!40000 ALTER TABLE `ding_block_list` DISABLE KEYS */;
INSERT INTO `ding_block_list` VALUES (2,4,'adminsir.net','网站adminsir.net，记录成长的点点滴滴，只因喜欢！Hello world！',1378791431,1383492559,'/dogocms/Public/Uploads/Images/20131103/1383492308.jpg',20,'http://www.baidu.com',20,'#123','快速预览','前去打探','',''),(3,4,'yoyomeishi.com','YOYO美食',1383490309,1383528852,'/dogocms/Public/Uploads/Images/20131103/1383492291.png',20,'http://yoyomeishi.com',0,'#123','快速预览','前去打探一番','',''),(4,4,'viboys.com','viboys',1383492335,1383492889,'/dogocms/Public/Uploads/Images/20131103/1383492334.jpg',20,'http://www.viboys.com',0,'#123','快速预览','前去打探','',''),(5,4,'vigirls.com','vigirls.com',1383492357,1383492899,'/dogocms/Public/Uploads/Images/20131103/1383492355.jpg',20,'http://www.vigirls.com',0,'#123','快速预览','前去打探','',''),(6,4,'vilove.net','vilove.net情趣内衣',1383492375,1383492910,'/dogocms/Public/Uploads/Images/20131103/1383492373.png',20,'http://www.vilove.net',0,'#123','快速预览','前去打探','',''),(7,4,'dangzhenshi.com','dangzhenshi.com当真是？当真事',1383492394,1383492921,'/dogocms/Public/Uploads/Images/20131103/1383492393.png',20,'http://www.dangzhenshi.com',0,'#123','快速预览','前去打探','',''),(8,4,'play17.com','play17.com',1383492412,1383529268,'/dogocms/Public/Uploads/Images/20131103/1383492411.png',20,'http://www.play17.com',0,'#123','快速预览','前去打探','',''),(9,4,'iotinfos.com','iotinfos.com',1383492428,1388467041,'/dogocms/Public/Uploads/Images/20131103/1383492427.jpg',20,'http://www.iotinfos.com',0,'#123','快速预览','前去打探','','');
/*!40000 ALTER TABLE `ding_block_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_block_sort`
--
...
--
-- Dumping data for table `ding_block_sort`
--

LOCK TABLES `ding_block_sort` WRITE;
/*!40000 ALTER TABLE `ding_block_sort` DISABLE KEYS */;
INSERT INTO `ding_block_sort` VALUES (4,'秋允优秀站点','y',1388412640),(3,'首页','n',NULL);
/*!40000 ALTER TABLE `ding_block_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_brand_list`
--

DROP TABLE IF EXISTS `ding_brand_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_brand_list` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `name` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `status` tinyint(4) DEFAULT '20' COMMENT '状态20 OK，10no',
  `brand_logo` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '品牌商家logo',
  `myorder` tinyint(4) DEFAULT '0' COMMENT '排序',
  `addtime` int(11) NOT NULL COMMENT '添加日期',
  `url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '商家URL',
...
--
-- Dumping data for table `ding_brand_list`
--

LOCK TABLES `ding_brand_list` WRITE;
/*!40000 ALTER TABLE `ding_brand_list` DISABLE KEYS */;
INSERT INTO `ding_brand_list` VALUES (2,'baidu2',10,'',0,0,'','',1388412422),(3,'baidu',20,'/dogocms/Public/Uploads/Images/20130904/1378302374.jpg',0,1378302256,'','',NULL);
/*!40000 ALTER TABLE `ding_brand_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_comment`
--
...
--
-- Dumping data for table `ding_comment`
--

LOCK TABLES `ding_comment` WRITE;
/*!40000 ALTER TABLE `ding_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_comment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_content`
--
...
--
-- Dumping data for table `ding_goods_attribute`
--

LOCK TABLES `ding_goods_attribute` WRITE;
/*!40000 ALTER TABLE `ding_goods_attribute` DISABLE KEYS */;
INSERT INTO `ding_goods_attribute` VALUES (1,1,'作者',111.00,20,20),(2,2,'出版社',2222.00,20,20),(3,3,'图书书号/ISBN',3.00,20,20),(4,4,'出版日期',4.00,20,20),(5,5,'开本',5.00,20,20),(6,6,'图书页数',6.00,20,20),(7,7,'黑白',7.00,20,20),(8,8,'图书规格',8.00,20,20),(9,9,'版次',9.00,20,20),(10,10,'印张',10.00,20,20),(11,11,'国际新闻',11.00,20,20),(12,12,'所属分类',12.00,20,20),(13,13,'',13.00,21,2),(14,14,'',14.00,21,2),(15,15,'',15.00,21,2),(16,16,'HDCD',16.00,21,2),(17,17,'',17.00,21,2),(18,18,'',18.00,21,2),(20,20,'',20.00,21,2),(23,23,'',23.00,21,2),(24,24,'有',24.00,21,2),(25,25,'碟片代码',25.00,21,2),(26,26,'',26.00,21,2),(27,27,'',27.00,21,2),(28,28,'',28.00,21,2),(29,29,'',29.00,21,2),(30,30,'',30.00,21,2),(31,31,'',31.00,21,2),(32,1,'',1.00,22,1),(33,2,'',2.00,22,1),(34,3,'',3.00,22,1),(35,4,'出版日期',4.00,22,1),(36,5,'',5.00,22,1),(37,6,'',6.00,22,1),(38,7,'黑白',7.00,22,1),(39,8,'',8.00,22,1),(40,9,'',9.00,22,1),(41,10,'',10.00,22,1),(42,11,'新闻',11.00,22,1),(43,12,'',12.00,22,1),(44,1,'作者22222',111.00,20,1),(45,2,'出版社',2222.00,20,1),(46,3,'图书书号/ISBN',0.00,20,1),(47,4,'出版日期',0.00,20,1),(48,5,'开本',0.00,20,1),(49,6,'图书页数',0.00,20,1),(50,7,'黑白',0.00,20,1),(51,8,'图书规格',0.00,20,1),(52,9,'版次',0.00,20,1),(53,10,'印张',0.00,20,1),(54,11,'国际新闻',11.00,20,1),(55,12,'所属分类',0.00,20,1),(56,1,'zuoc222',0.00,19,1),(57,2,'',0.00,19,1),(58,3,'',0.00,19,1),(59,4,'',0.00,19,1),(60,5,'',0.00,19,1),(61,6,'',0.00,19,1),(62,7,'平装',0.00,19,1),(63,8,'',0.00,19,1),(64,9,'',0.00,19,1),(65,10,'',0.00,19,1),(66,11,'新闻',0.00,19,1),(67,12,'',0.00,19,1),(68,1,'',1.00,22,1),(69,2,'',2.00,22,1),(70,3,'',0.00,22,1),(71,4,'出版日期',0.00,22,1),(72,5,'',0.00,22,1),(73,6,'',0.00,22,1),(74,7,'黑白',0.00,22,1),(75,8,'',0.00,22,1),(76,9,'',0.00,22,1),(77,10,'',0.00,22,1),(78,11,'新闻',11.00,22,1),(79,12,'',0.00,22,1),(80,13,'',0.00,21,2),(81,14,'',0.00,21,2),(82,15,'',0.00,21,2),(83,16,'HDCD',0.00,21,2),(84,17,'',0.00,21,2),(85,18,'',0.00,21,2),(86,20,'',0.00,21,2),(87,21,'主唱',0.00,21,2),(88,23,'',0.00,21,2),(89,24,'有',0.00,21,2),(90,25,'碟片代码',0.00,21,2),(91,26,'',0.00,21,2),(92,27,'',0.00,21,2),(93,28,'',0.00,21,2),(94,29,'',0.00,21,2),(95,30,'',0.00,21,2),(96,31,'',0.00,21,2),(97,13,'',0.00,21,2),(98,14,'',0.00,21,2),(99,15,'',0.00,21,2),(100,16,'HDCD',0.00,21,2),(101,17,'',0.00,21,2),(102,18,'',0.00,21,2),(103,20,'',0.00,21,2),(104,23,'',0.00,21,2),(105,24,'有',0.00,21,2),(106,25,'碟片代码',0.00,21,2),(107,26,'',0.00,21,2),(108,27,'',0.00,21,2),(109,28,'',0.00,21,2),(110,29,'',0.00,21,2),(111,30,'',0.00,21,2),(112,31,'',0.00,21,2),(113,13,'',0.00,21,2),(114,14,'',0.00,21,2),(115,15,'',0.00,21,2),(116,16,'HDCD',0.00,21,2),(117,17,'',0.00,21,2),(118,18,'',0.00,21,2),(119,20,'',0.00,21,2),(120,21,'主唱',0.00,21,2),(121,23,'',0.00,21,2),(122,24,'有',0.00,21,2),(123,25,'碟片代码',0.00,21,2),(124,26,'',0.00,21,2),(125,27,'',0.00,21,2),(126,28,'',0.00,21,2),(127,29,'',0.00,21,2),(128,30,'',0.00,21,2),(129,31,'',0.00,21,2),(130,1,'zuoc222',0.00,19,1),(131,2,'',0.00,19,1),(132,3,'',0.00,19,1),(133,4,'',0.00,19,1),(134,5,'',0.00,19,1),(135,6,'',0.00,19,1),(136,7,'平装',0.00,19,1),(137,8,'',0.00,19,1),(138,9,'',0.00,19,1),(139,10,'',0.00,19,1),(140,11,'新闻',0.00,19,1),(141,12,'',0.00,19,1);
/*!40000 ALTER TABLE `ding_goods_attribute` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_goods_content`
--

DROP TABLE IF EXISTS `ding_goods_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_goods_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ding_goods_content`
--

LOCK TABLES `ding_goods_content` WRITE;
/*!40000 ALTER TABLE `ding_goods_content` DISABLE KEYS */;
INSERT INTO `ding_goods_content` VALUES (1,1,'dede'),(2,0,'dede'),(3,3,'dede'),(4,0,'dede'),(5,5,'dede'),(6,0,'dede'),(7,7,''),(8,0,''),(9,9,''),(10,0,''),(11,11,''),(12,0,''),(13,13,''),(14,0,''),(15,15,''),(16,19,'dedede222222'),(17,20,'dedededeceshi'),(18,21,''),(19,22,'');
/*!40000 ALTER TABLE `ding_goods_content` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_goods_gallery`
--

DROP TABLE IF EXISTS `ding_goods_gallery`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_goods_gallery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '图片名称',
  `img_url` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '图片地址',
...
--
-- Dumping data for table `ding_goods_gallery`
--

LOCK TABLES `ding_goods_gallery` WRITE;
/*!40000 ALTER TABLE `ding_goods_gallery` DISABLE KEYS */;
INSERT INTO `ding_goods_gallery` VALUES (10,'444','http://localhost/dogocms/Public/Style/images/logo.gif',22),(11,'111111','http://localhost/dogocms/Public/Style/images/logo.gif',19),(12,'111','http://localhost/dogocms/Public/Style/images/logo.gif',22);
/*!40000 ALTER TABLE `ding_goods_gallery` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_goods_list`
--

DROP TABLE IF EXISTS `ding_goods_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_goods_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `number` smallint(6) DEFAULT '0' COMMENT '编号',
  `stock` smallint(6) DEFAULT '0' COMMENT '库存',
  `stockalert` smallint(6) DEFAULT '0' COMMENT '警报库存',
  `is_sale` tinyint(4) DEFAULT '20' COMMENT '是否销售',
  `market_price` decimal(10,2) DEFAULT '0.00' COMMENT '市场价格',
  `shop_price` decimal(10,2) DEFAULT '0.00' COMMENT '商城价格',
  `addtime` int(10) DEFAULT NULL COMMENT '添加商品日期',
  `selltime` int(10) DEFAULT NULL COMMENT '开始销售上架日期',
  `soldouttime` int(10) DEFAULT NULL COMMENT '下架日期',
  `updatetime` int(10) DEFAULT NULL COMMENT '更新日期',
  `status` tinyint(4) NOT NULL DEFAULT '20' COMMENT '状态20已经审核，10未审核，11驳回审核',
  `uid` smallint(6) DEFAULT NULL COMMENT '操作人员ID',
  `brand_id` mediumint(9) NOT NULL COMMENT '品牌商家id',
  `sort_id` mediumint(9) DEFAULT NULL COMMENT '分类id',
  `views` mediumint(9) NOT NULL DEFAULT '0' COMMENT '浏览量',
  `is_recycle` tinyint(4) NOT NULL DEFAULT '10' COMMENT '是否加入回收站10否，20是',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_goods_list`
--

LOCK TABLES `ding_goods_list` WRITE;
/*!40000 ALTER TABLE `ding_goods_list` DISABLE KEYS */;
INSERT INTO `ding_goods_list` VALUES (1,'deded','dede','','','',0,0,0,20,0.00,0.00,1378648570,0,0,1378648570,20,1,2,36,0,10),(2,'',NULL,'',NULL,NULL,0,0,0,20,0.00,0.00,NULL,NULL,NULL,NULL,20,NULL,0,NULL,0,10),(3,'deded','dede','','','',0,0,0,20,0.00,0.00,1378648578,0,0,1378648578,20,1,2,36,0,10),(4,'',NULL,'',NULL,NULL,0,0,0,20,0.00,0.00,NULL,NULL,NULL,NULL,20,NULL,0,36,0,10),(5,'deded','dede','','','',0,0,0,20,0.00,0.00,1378648582,0,0,1378648582,20,1,2,36,0,10),(6,'',NULL,'',NULL,NULL,0,0,0,20,0.00,0.00,NULL,NULL,NULL,NULL,20,NULL,0,36,0,10),(7,'dede','','','','',0,0,0,20,0.00,0.00,1378648640,0,0,1378648640,20,1,0,36,0,10),(9,'dede','','','','',0,0,0,20,0.00,0.00,1378648665,0,0,1378648665,20,1,0,36,0,10),(10,'',NULL,'',NULL,NULL,0,0,0,20,0.00,0.00,NULL,NULL,NULL,NULL,20,NULL,0,36,0,10),(11,'ceshi1','','','','',0,0,0,20,0.00,0.00,1378648679,0,0,1378648679,20,1,0,36,0,10),(12,'',NULL,'',NULL,NULL,0,0,0,20,0.00,0.00,NULL,NULL,NULL,NULL,20,NULL,0,36,0,10),(13,'ceshi2','','','','',0,0,0,20,0.00,0.00,1378648706,0,0,1378648706,20,1,0,36,0,10),(14,'',NULL,'',NULL,NULL,0,0,0,20,0.00,0.00,NULL,NULL,NULL,NULL,20,NULL,0,NULL,0,20),(15,'ceshi3','','','','',0,0,0,20,0.00,0.00,1378648751,0,0,1378648751,20,1,0,36,0,10),(16,'frfr','','','','',0,0,0,20,0.00,0.00,1378651771,0,0,1378651771,20,1,0,36,0,10),(17,'ceshi3','dede','','','',0,0,0,20,0.00,0.00,1378652328,0,0,1378652328,20,1,0,36,0,10),(18,'test1','','','','',0,0,0,20,0.00,0.00,1378652427,0,0,1378652427,20,1,0,36,0,10),(19,'test12222','','','','',0,0,0,20,0.00,0.00,1378652517,0,0,1388411684,20,1,0,36,0,10),(21,'测试','','','','',0,3,0,20,0.00,0.00,1378807725,0,0,1388411675,20,1,2,38,0,10),(22,'测试','','','','',0,16,0,20,0.00,0.00,1378807774,0,0,1379032997,20,1,0,36,0,10);
/*!40000 ALTER TABLE `ding_goods_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_goods_sort`
--
...
CREATE TABLE `ding_goods_sort` (
  ...
  `path` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT ',',
  `myorder` tinyint(3) NOT NULL,
  `status` enum('y','n') CHARACTER SET utf8 DEFAULT 'n',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_goods_sort`
--

LOCK TABLES `ding_goods_sort` WRITE;
/*!40000 ALTER TABLE `ding_goods_sort` DISABLE KEYS */;
INSERT INTO `ding_goods_sort` VALUES (36,0,'ce','ce',1,'','',',',0,'n'),(38,0,'zhongwen','zhongwen',2,'','',',',0,'n');
/*!40000 ALTER TABLE `ding_goods_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_linkpage_list`
--
...
--
-- Dumping data for table `ding_linkpage_list`
--

LOCK TABLES `ding_linkpage_list` WRITE;
/*!40000 ALTER TABLE `ding_linkpage_list` DISABLE KEYS */;
INSERT INTO `ding_linkpage_list` VALUES (1,0,'呵呵',',',1,0,NULL),(2,1,'嘿嘿我',',1,',1,0,NULL),(3,0,'呵呵',',',1,0,NULL),(4,0,'嘿嘿',',',2,0,NULL),(6,0,'山东',',',6,0,1389495287),(7,6,'济南',',6,',6,0,1389495294);
/*!40000 ALTER TABLE `ding_linkpage_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_linkpage_sort`
--
...
--
-- Dumping data for table `ding_linkpage_sort`
--

LOCK TABLES `ding_linkpage_sort` WRITE;
/*!40000 ALTER TABLE `ding_linkpage_sort` DISABLE KEYS */;
INSERT INTO `ding_linkpage_sort` VALUES (6,'地区','diqu','y',0,1389495270);
/*!40000 ALTER TABLE `ding_linkpage_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_links`
--
...
--
-- Dumping data for table `ding_links`
--

LOCK TABLES `ding_links` WRITE;
/*!40000 ALTER TABLE `ding_links` DISABLE KEYS */;
INSERT INTO `ding_links` VALUES (2,1,'站长先生','http://www.adminsir.net','/Public/Uploads/Images/20130128/1359340690.jpg',0,'y','的',1359340987,1388412656),(3,2,'齐鲁企业2','http://www.qiluqiye.com','/Public/Uploads/Images/20130128/1359340690.jpg',0,'n','de得的',1359344022,1388412652);
/*!40000 ALTER TABLE `ding_links` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_links_sort`
--
...
--
-- Dumping data for table `ding_links_sort`
--

LOCK TABLES `ding_links_sort` WRITE;
/*!40000 ALTER TABLE `ding_links_sort` DISABLE KEYS */;
INSERT INTO `ding_links_sort` VALUES (2,'shoue','n',1388413054);
/*!40000 ALTER TABLE `ding_links_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_members`
--
...
CREATE TABLE `ding_members` (
  ...
  `status` tinyint(4) DEFAULT '20' COMMENT '会员状态10禁用，20可用',
  `updatetime` int(10) DEFAULT NULL COMMENT '更新时间',
  `email` varchar(255) DEFAULT NULL COMMENT '邮箱',
  `sex` varchar(45) DEFAULT '13' COMMENT '性别10男，11女，12保密',
  `telphone` varchar(25) DEFAULT NULL COMMENT '手机号',
  `ip` varchar(45) DEFAULT NULL COMMENT '注册ip',
  `email_status` tinyint(4) DEFAULT '20' COMMENT '邮箱认证状态10未认证，20已认证',
  `email_key` varchar(45) DEFAULT NULL COMMENT '邮件随机数',
  `email_sendtime` int(10) DEFAULT NULL COMMENT '发送认证邮件的时间',
  `email_authtime` int(10) DEFAULT NULL COMMENT '邮件认证时间',
...
--
-- Dumping data for table `ding_members`
--

LOCK TABLES `ding_members` WRITE;
/*!40000 ALTER TABLE `ding_members` DISABLE KEYS */;
INSERT INTO `ding_members` VALUES (6,'djc6914','cd1396ec181cbe0b0240795b1734d105',1389101422,'n',20,1389509383,'335499289@qq.com','12',NULL,'0.0.0.0',20,NULL,NULL,NULL,'我的个性签名',485452800);
/*!40000 ALTER TABLE `ding_members` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_members_address`
--

DROP TABLE IF EXISTS `ding_members_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_members_address` (
  `id` mediumint(9) NOT NULL AUTO_INCREMENT,
  `members_id` mediumint(5) DEFAULT NULL COMMENT '会员编号',
  `address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '收货地址',
  `is_default` tinyint(4) DEFAULT '10' COMMENT '默认地址10否，20是',
  `name` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '收货人',
  `telphone` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '手机',
  `zipcode` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `province` mediumint(8) DEFAULT NULL COMMENT '省市',
  `city` mediumint(8) DEFAULT NULL COMMENT '城市',
  `county` mediumint(8) DEFAULT NULL COMMENT '区县',
  `addtime` int(10) DEFAULT NULL COMMENT '添加时间',
  `updatetime` int(10) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='收货地址';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_members_address`
--

LOCK TABLES `ding_members_address` WRITE;
/*!40000 ALTER TABLE `ding_members_address` DISABLE KEYS */;
INSERT INTO `ding_members_address` VALUES (6,6,'22222',10,'name','123456','245000',0,0,0,1389504109,1389504109),(7,6,'eeee222',10,'name2','123456','245000',0,0,0,1389504343,1389505924),(8,6,'eeee',10,'name','123456','245000',0,0,0,1389504346,1389504346),(11,6,'山大南路15号',20,'丁继才','13969050052','250000',0,0,0,1389509857,1389509950),(12,6,'15',10,'丁继才','13969050052','250000',0,0,0,1389509972,1389509972);
/*!40000 ALTER TABLE `ding_members_address` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_message`
--
...
--
-- Dumping data for table `ding_message`
--

LOCK TABLES `ding_message` WRITE;
/*!40000 ALTER TABLE `ding_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_message` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_message_sort`
--
...
--
-- Dumping data for table `ding_message_sort`
--

LOCK TABLES `ding_message_sort` WRITE;
/*!40000 ALTER TABLE `ding_message_sort` DISABLE KEYS */;
INSERT INTO `ding_message_sort` VALUES (3,'ggg','y',NULL);
/*!40000 ALTER TABLE `ding_message_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_model_field`
--
...
--
-- Dumping data for table `ding_model_field`
--

LOCK TABLES `ding_model_field` WRITE;
/*!40000 ALTER TABLE `ding_model_field` DISABLE KEYS */;
INSERT INTO `ding_model_field` VALUES (1,'文档1',1,'dwend1','varchar',0,'','30',0,NULL),(2,'文档2',1,'dwend2','varchar',0,'','20',0,NULL),(3,'ceshi',6,'ce1','stepselect',6,'de','220',1,1388467468),(4,'ceshi',7,'ceshi1','varchar',0,'ss','200',0,NULL);
/*!40000 ALTER TABLE `ding_model_field` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_model_sort`
--
...
--
-- Dumping data for table `ding_model_sort`
--

LOCK TABLES `ding_model_sort` WRITE;
/*!40000 ALTER TABLE `ding_model_sort` DISABLE KEYS */;
INSERT INTO `ding_model_sort` VALUES (6,'ceshi','dceshi22','y',0,1388467461),(7,'eeee','dceshi19','y',0,NULL);
/*!40000 ALTER TABLE `ding_model_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_nav_foot`
--
...
CREATE TABLE `ding_nav_foot` (
  ...
  `status` tinyint(4) DEFAULT '10' COMMENT '是否显示',
  `updatetime` int(10) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `ding_nav_foot`
--

LOCK TABLES `ding_nav_foot` WRITE;
/*!40000 ALTER TABLE `ding_nav_foot` DISABLE KEYS */;
INSERT INTO `ding_nav_foot` VALUES (13,0,'导航首页',',',0,NULL,20,1389246293),(14,0,'底部首页',',',0,NULL,20,1389246302),(15,0,'得得',',',0,NULL,20,1389246420),(16,14,'1112',',14,',0,NULL,20,1389246751);
/*!40000 ALTER TABLE `ding_nav_foot` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_nav_head`
--
...
--
-- Dumping data for table `ding_nav_head`
--

LOCK TABLES `ding_nav_head` WRITE;
/*!40000 ALTER TABLE `ding_nav_head` DISABLE KEYS */;
INSERT INTO `ding_nav_head` VALUES (1,0,'首页',',',0,'','n',1388320067),(2,0,'视频教程',',',0,'List/5','y',NULL),(3,0,'开源项目',',',0,'List/?id=28','y',NULL),(4,0,'物联网32',',',0,'List/?id=25','y',1388320455),(5,0,'推荐书籍',',',0,'List/?id=24','y',NULL),(6,0,'网站建设',',',0,'List/?id=23','y',NULL),(7,0,'web开发',',',0,'List/?id=14','y',NULL),(8,0,'图形图像',',',0,'List/?id=12','n',NULL),(9,0,'网络资讯',',',0,'List/?id=1','y',NULL),(10,0,'休闲一刻',',',0,'List/?id=31','y',NULL),(11,0,'电商学院',',',0,'List/?id=32','y',NULL),(12,0,'励志一生',',',0,'List/?id=29','y',NULL);
/*!40000 ALTER TABLE `ding_nav_head` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_news_sort`
--
...
--
-- Dumping data for table `ding_news_sort`
--

LOCK TABLES `ding_news_sort` WRITE;
/*!40000 ALTER TABLE `ding_news_sort` DISABLE KEYS */;
INSERT INTO `ding_news_sort` VALUES (35,0,'cece','cece',6,'','',',',0,'n',NULL),(36,35,'得得','dede',0,'','',',35,',0,'n',1388411630);
/*!40000 ALTER TABLE `ding_news_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_operators`
--
...
CREATE TABLE `ding_operators` (
  ...
  `is_recycle` enum('n','y') DEFAULT 'n' COMMENT '是否加入回收站n否，y是',
...
--
-- Dumping data for table `ding_operators`
--

LOCK TABLES `ding_operators` WRITE;
/*!40000 ALTER TABLE `ding_operators` DISABLE KEYS */;
INSERT INTO `ding_operators` VALUES (1,'admin','d625662744e4c61e46c8c51042a7a989',1346390052,'n','y');
/*!40000 ALTER TABLE `ding_operators` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_order_item`
--

DROP TABLE IF EXISTS `ding_order_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_order_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='订单明细表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_order_item`
--

LOCK TABLES `ding_order_item` WRITE;
/*!40000 ALTER TABLE `ding_order_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_order_item` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_order_list`
--

DROP TABLE IF EXISTS `ding_order_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_order_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='订单列表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_order_list`
--

LOCK TABLES `ding_order_list` WRITE;
/*!40000 ALTER TABLE `ding_order_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_order_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_pages`
--
...
--
-- Dumping data for table `ding_pages`
--

LOCK TABLES `ding_pages` WRITE;
/*!40000 ALTER TABLE `ding_pages` DISABLE KEYS */;
INSERT INTO `ding_pages` VALUES (6,4,'多担待','','','',1378861259,1388411375,'y');
/*!40000 ALTER TABLE `ding_pages` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_pages_sort`
--
...
--
-- Dumping data for table `ding_pages_sort`
--

LOCK TABLES `ding_pages_sort` WRITE;
/*!40000 ALTER TABLE `ding_pages_sort` DISABLE KEYS */;
INSERT INTO `ding_pages_sort` VALUES (4,0,'得得','0',',','y','','',NULL,0,1388411521);
/*!40000 ALTER TABLE `ding_pages_sort` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_payment`
--

DROP TABLE IF EXISTS `ding_payment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_payment` (
  `id` tinyint(4) NOT NULL AUTO_INCREMENT,
  `code` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '支付编码',
  `name` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '支付名称',
  `fee` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '费率',
  `description` text COLLATE utf8_unicode_ci COMMENT '描述',
  `myorder` tinyint(4) DEFAULT NULL COMMENT '排序',
  `config` text COLLATE utf8_unicode_ci COMMENT '配置信息',
  `status` varchar(45) COLLATE utf8_unicode_ci DEFAULT '20' COMMENT '状态20启用，10禁用',
  `is_cod` tinyint(4) DEFAULT '10' COMMENT '是否货到付款20是，10否',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='支付配置信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_payment`
--

LOCK TABLES `ding_payment` WRITE;
/*!40000 ALTER TABLE `ding_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_payment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_setting`
--
...
--
-- Dumping data for table `ding_setting`
--

LOCK TABLES `ding_setting` WRITE;
/*!40000 ALTER TABLE `ding_setting` DISABLE KEYS */;
INSERT INTO `ding_setting` VALUES (1,'cfg_sitename','当真是，当真事？！','网站名称',1,'text',0,1389706793),(2,'cfg_siteurl','23','网站地址',1,'text',0,NULL),(3,'cfg_keywords','站长先生,站长教程,网站教程,管理先生','关键字',1,'text',0,NULL),(4,'cfg_description','记录成长的点点滴滴，只因喜欢！Hello world！我的电脑我管理，我的web我做主！','网站描述',1,'text',0,NULL),(5,'cfg_defaultpic','defaultpic.gif','默认图片',1,'text',0,NULL),(6,'cfg_copyright','© （<a href=\\\"http://www.adminsir.net\\\">www.adminsir.net</a>）站长先生网--版权所有，并保留所有权利。<br />\r\nPowered by <a href=\\\"http://www.dingcms.com\\\" target=\\\"_blank\\\">www.dingcms.com</a><a href=\\\"http://webscan.360.cn/index/checkwebsite/url/www.adminsir.net\\\"></a>','版权信息',1,'textarea',0,NULL),(11,'cfg_title','测试','站点标题',1,'text',0,1389691927),(12,'cfg_skin_web','default','网站模板',1,'text',0,1388320058),(13,'cfg_member_skin','default','会员中心模板',6,'text',0,1388639393);
/*!40000 ALTER TABLE `ding_setting` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_shipping`
--

DROP TABLE IF EXISTS `ding_shipping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_shipping` (
  `id` tinyint(4) NOT NULL AUTO_INCREMENT,
  `code` varchar(45) COLLATE utf8_unicode_ci NOT NULL COMMENT '编号代码',
  `name` varchar(45) COLLATE utf8_unicode_ci NOT NULL COMMENT '名称',
  `description` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '描述',
  `insure` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '保费百分比',
  `cod_status` varchar(45) COLLATE utf8_unicode_ci NOT NULL DEFAULT '10' COMMENT '货到付款10不支持，20支持',
  `status` varchar(45) COLLATE utf8_unicode_ci NOT NULL DEFAULT '20' COMMENT '状态10禁用，20启用',
  `myorder` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='物流方式信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_shipping`
--

LOCK TABLES `ding_shipping` WRITE;
/*!40000 ALTER TABLE `ding_shipping` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_shipping` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_shipping_config`
--

DROP TABLE IF EXISTS `ding_shipping_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_shipping_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `area_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '地区名称',
  `shipping_id` tinyint(4) DEFAULT NULL COMMENT '物流ID',
  `configure` text COLLATE utf8_unicode_ci COMMENT '参数配置',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='物流地区配置信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_shipping_config`
--

LOCK TABLES `ding_shipping_config` WRITE;
/*!40000 ALTER TABLE `ding_shipping_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_shipping_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_shipping_region`
--

DROP TABLE IF EXISTS `ding_shipping_region`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ding_shipping_region` (
  `shipping_config_id` smallint(6) NOT NULL COMMENT '物流ID',
  `region_id` smallint(6) NOT NULL COMMENT '地区ID'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='物流与地区对应关系表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_shipping_region`
--

LOCK TABLES `ding_shipping_region` WRITE;
/*!40000 ALTER TABLE `ding_shipping_region` DISABLE KEYS */;
/*!40000 ALTER TABLE `ding_shipping_region` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ding_title`
--
...
CREATE TABLE `ding_title` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT '10' COMMENT '10未审核，11未审核通过，12已审核',
  `is_recycle` tinyint(4) NOT NULL DEFAULT '10' COMMENT '10未加入回收站，11加入回收站',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='标题表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ding_title`
--

LOCK TABLES `ding_title` WRITE;
/*!40000 ALTER TABLE `ding_title` DISABLE KEYS */;
INSERT INTO `ding_title` VALUES (1,1,0,0,'测试文章','测试文章','',NULL,'','','','','测试文章','测试文章',179,1355799013,1355799013,12,10),(2,1,0,0,'测试文章2','测试文章3','',NULL,'','','','','测试文章','测试文章',169,1355799013,1355799013,12,10),(3,1,0,0,'测试文章3','测试文章3','',NULL,'','','','','测试文章','测试文章',168,1355799013,1355799013,12,10),(4,1,0,0,'测试文章4','测试文章4',NULL,NULL,'','','','','','',0,1355799013,1355799013,12,10),(5,1,0,0,'测试文章5','测试文章5',NULL,NULL,'','','','','','',0,1355799013,1355799013,12,10),(7,1,0,0,'测试文章7','测试文章7',NULL,NULL,'','','','','','',0,1355799013,1355799013,12,10),(8,1,0,0,'测试文章8','测试文章8',NULL,NULL,'','','','','','',0,1355799013,1355799013,12,10),(9,1,0,0,'测试文章9','测试文章9',NULL,NULL,'','','','','','',1,1355799013,1355799013,12,10),(10,1,0,0,'测试文章10222','测试文章10','',NULL,'','','','','','测试文章10222',0,1355799013,1355799013,12,10),(11,2,0,0,'测试文章11','测试文章11',NULL,NULL,'','','','','','',0,1355799013,1355799013,12,10),(12,2,0,0,'测试文章12','测试文章12',NULL,NULL,'','','','','','',0,1355799013,1355799013,12,10),(13,1,0,0,'的的的2','','','h','','','','','','',7,0,0,12,10),(14,27,0,0,'M2M简介','M2M简介','',NULL,'','','','','','',1,0,0,12,10),(15,27,0,0,'实时数据库和关系数据库的设计特点','','',NULL,'','','','','','',4,0,0,0,10),(16,27,0,0,'朱志祥讲物联网（一）','','',NULL,'','','','','','',92,0,0,1,10),(17,27,0,0,'解析M2M：物联网的四大支撑技术之一','','',NULL,'','','','','','',101,0,0,1,10),(18,27,0,0,'全网通址 物联网时代手机是什么','','',NULL,'','','','','','',166,0,0,1,10),(19,27,0,0,'红外线感应器','','',NULL,'','','','','','',150,0,0,1,10),(20,27,1,0,'ZigBee技术在物联网系统中的应用研究','','',NULL,'','','','','','随着互联网技术、无线传感技术、信息处理技术的快速发展，物联网技术得到越来越多的重视。 2003年，美国《技术评论》提出物联网将是未来改变人们生活的十大技术之首，物联网是在计算机互联网的基础上，利用电子商品代码EPC、RFID、无线 数据通信等技术，构造的一个覆盖世界上万事万物的信息网络，是独立于EPC系统和互联网技术整合的产物。物联网一方面可以提高经济效益，大大节约成本，另 一方面可以为全球经济的复苏提供技术动力。',196,0,1368711753,1,10),(21,27,0,0,'浅析公共安全监测物联网技术','','',NULL,'','','','','浅析公共安全监测物联网技术','浅析公共安全监测物联网技术',256,0,0,1,10),(22,36,1,0,'物联网冰箱2','','/Public/Uploads/Images/20130131/1359606096.jpg','r','','','','','','',258,0,1389747661,1,10),(23,36,1,0,'deded','dede',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,12,10),(24,36,1,0,'deded','dede','',NULL,'','','','','','',0,0,1389761781,10,10),(25,36,1,0,'deded','dede','',NULL,'','','','','','',0,0,1389761774,12,10);
/*!40000 ALTER TABLE `ding_title` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-01-15 22:13:54
