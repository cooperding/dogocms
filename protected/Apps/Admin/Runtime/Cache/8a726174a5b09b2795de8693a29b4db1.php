<?php if (!defined('THINK_PATH')) exit();?><table  id="datagrid_settingtab<?php echo ($id); ?>" class="datagrid">
...
<script>
    $(function(){
        ...
        var urljson = '__APP__/Setting/listJsonId?id=<?php echo ($id); ?>';
        ...
        $('#datagrid_'+classId).datagrid({
            ...
            columns:[[
                    ...
                    {field:'sys_info',title:'参数名称',width:200},
                    {field:'sys_value',title:'参数值',width:200},
                    {field:'sys_name',title:'参数变量',width:80},
                    {
                        field:'action',
                        title:'操作',
                        width:50,
