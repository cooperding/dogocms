...
<script>
    $(function(){
        ...
        var hrefadd = '__APP__/News/add?id=<?php echo ($id); ?>';
        var hrefedit = '__APP__/News/edit';
        var hrefcancel = '__APP__/News/delete';
        var urljson = '__APP__/News/listJsonId?id=<?php echo ($id); ?>';
